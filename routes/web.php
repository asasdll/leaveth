...
Route::get('qr-code-g', function () {
  ...
  Route::get('le_date_edit/{id}', 'Date_leaveController@edit')->middleware('auth');
  Route::post('leave_date_up/{id}', 'Date_leaveController@update')->middleware('auth');
  Route::get('sum_date', 'Date_leaveController@sum')->middleware('auth');
  Route::get('add_date', 'Add_dateController@index')->middleware('auth');
  Route::get('add_/{id}', 'Add_dateController@create')->middleware('auth');
  Route::post('lv_date/{id}', 'Add_dateController@store')->middleware('auth');
