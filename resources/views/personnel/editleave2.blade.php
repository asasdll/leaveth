                                        ...
                                        <div class="container">
                                                ...
                                                <div class="col-md-12 pr-1">
                                                    <div class="form-group row">
                                                        <label for="text" class="col-sm-2 col-form-label">เนื่องจาก</label>
                                                            <div class="col-md-8 pr-1">
                                                            <input type="text" class="form-control"  name="since"   value="{{$chief->since}}" id="text" required>
                                                            </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 pr-1">
                                                    <input class="form-control" type="date" id="example-date-input"  value="{{$chief->date1}}" name="date1" required>
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="col md-4 pr-1">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8 pr-1">
                                                    <input class="form-control" type="date"  id="example-date-input"  value="{{$chief->date2}}" name="date2" required>
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="col-md-4 pr">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6 pr-1">
                                                        <input type="text" class="form-control"  value="{{$chief->da}}" name="da" id="da" required>
                                                    </div>
